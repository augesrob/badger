  ...
  return (
    ...
    <div>
      ...
      <div className="flex gap-4 items-start overflow-hidden">
        {/* LEFT: Loading Doors */}
        <div className="flex-1 min-w-0 overflow-y-auto" style={{ height: 'calc(100dvh - 49px - 16px - 68px)', minHeight: 0 }}>
        ...
        <div className="hidden lg:block w-[200px] flex-shrink-0 overflow-y-auto" style={{ height: 'calc(100dvh - 49px - 16px - 68px)', minHeight: 0, position: 'sticky', top: 16 }}>
